  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center gap-2">
        <div className="flex h-6 w-6 items-center justify-center rounded-md" style={{ background: "var(--red-soft-bg)" }}>
        ...
        <span className="text-[12px] font-semibold" style={{ color: "var(--text-muted)" }}>핵심 포인트</span>
      </div>
